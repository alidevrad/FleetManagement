...
namespace FleetManagement.Persistence.EF.Migrations.CommandDbContext
{
    ...
    [Migration("20250204200808_InitAfterManyDesign")]
    partial class InitAfterManyDesign
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FleetManagement.Domain.Models.Customers.Customer", b =>
                {
                    b.OwnsMany("FleetManagement.Domain.Models.Customers.Branch", "Branches", b1 =>
                        {
                            ...
                            b1.OwnsMany("FleetManagement.Domain.Models.Customers.PhoneNumber", "PhoneNumbers", b2 =>
                                {
                    ...
                    b.OwnsMany("FleetManagement.Domain.Models.Customers.PhoneNumber", "PhoneNumbers", b1 =>
                        {
                            b1.Property<long>("CustomerId")
                                .HasColumnType("bigint");
