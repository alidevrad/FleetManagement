...
namespace FleetManagement.Persistence.EF.Migrations.CommandDbContext
{
    ...
    [Migration("20250216213929_AddTrip")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FleetManagement.Domain.Models.Trips.Trip", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<double>("TotalDelayTime")
                        .HasColumnType("float");

                    b.Property<double>("TotalFuelConsumption")
                        .HasColumnType("float");

                    b.Property<double>("TotalTripDuration")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("FleetManagement.Domain.Models.Drivers.Driver", b =>
                {
                    ...
                    b.OwnsMany("FleetManagement.Domain.Models.Shared.ReservationPeriod", "ReservationPeriods", b1 =>
                        {
                            b1.Property<long>("DriverId")
                                .HasColumnType("bigint");
                            ...
                            b1.ToTable("DriverReservationPeriods", "Fleet");
            ...
            modelBuilder.Entity("FleetManagement.Domain.Models.Trips.Trip", b =>
                {
                    b.OwnsMany("FleetManagement.Domain.Models.Trips.SubTrip", "SubTrips", b1 =>
                        {
                            b1.Property<long>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint");
                            ...
                            b1.Property<double>("DelayTimeValue")
                                .HasColumnType("float");
                            ...
                            b1.Property<double>("FuelConsumption")
                                .HasColumnType("float");
                            ...
                            b1.Property<string>("RouteDetails")
                            ...
                            b1.ToTable("SubTrips", "Fleet");

                            b1.WithOwner()
                                .HasForeignKey("TripId");

                            b1.OwnsOne("FleetManagement.Domain.Models.Trips.DeliveryPoint", "DeliveryPoint", b2 =>
                                {
                                    b2.Property<long>("SubTripId")
                                        .HasColumnType("bigint");
                                    ...
                                    b2.ToTable("SubTrips", "Fleet");

                                    b2.WithOwner()
                                        .HasForeignKey("SubTripId");
                                });

                            b1.Navigation("DeliveryPoint");
                        });

                    b.Navigation("SubTrips");
                });
                    ...
                    b.OwnsMany("FleetManagement.Domain.Models.Shared.ReservationPeriod", "ReservationPeriods", b1 =>
                        {
                            ...
                            b1.ToTable("VehicleReservationPeriods", "Fleet");
