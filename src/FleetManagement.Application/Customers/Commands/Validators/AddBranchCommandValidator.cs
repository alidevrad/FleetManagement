...
public class AddBranchCommandValidator : AbstractValidator<AddBranchCommand>
{
    public AddBranchCommandValidator()
    {
        ...
        RuleFor(b => b.Address)
                ...
                .MaximumLength(200).WithMessage("Branch address must be at most 255 characters.");

        RuleFor(b => b.AgentFullName)
            .NotEmpty().WithMessage("Agent's full name is required.")
            .MaximumLength(200).WithMessage("Agent's full name must be at most 200 characters.");
